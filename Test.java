...
public class Test 
{
	...
	public static void searchByBrand(String brand, List<Product> p)
	{
	...
	public static void searchByMemory(String memory, List<Product> p)
	{
		List<Product> results = new ArrayList<>();
		memory += "gb";
		int i = 0;
	...
	public static void searchByBrandAndMemory(String brand, String memory, List<Product> p)
	{
		List<Product> results = new ArrayList<>();
		memory += "gb";
		int i = 0;
        ...
        while(user_option!=4)
        {
        	...
        	switch(user_option)
        	{
        		...
        		case 3:
        		{
        			...
        			System.out.println("Enter memory size (in GB): ");
        			memory = sc.next();
        			searchByBrandAndMemory(brand, memory, monthly);
	...
	public static void pageRankingDemo() throws IOException
	{
        ...
        pageRankMap =PageRanking.calculatePageRank(query);
